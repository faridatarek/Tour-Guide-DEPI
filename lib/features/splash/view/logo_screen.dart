...
class _LogoScreenState extends State<LogoScreen> {
  ...
  void initState() {
    ...
    Timer(Duration(seconds: 6), () {
      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>GuidePager()), (route) => false);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Center(
        child: Stack(
          children: [
            Image.asset(ImagePaths.bg_logo,height: MediaQuery.of(context).size.height,fit: BoxFit.fitHeight,),
            FadeInDown(
